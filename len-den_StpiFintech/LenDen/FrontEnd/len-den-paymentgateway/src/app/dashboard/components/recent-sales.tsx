    ...
    <div className="space-y-8">
      <div className="flex items-center bg-secondary p-4 rounded-xl">
        ...
        <div className="ml-4 space-y-1">
          <p className="text-sm font-medium leading-none text-secondary-foreground">{customerName}</p>
          <p className="text-sm text-muted-foreground">
            {email}
          </p>
        </div>
        <div className="ml-auto font-medium text-secondary-foreground">+ INR {amount.toFixed(2)}</div>
      </div>
    </div>
  );
}
